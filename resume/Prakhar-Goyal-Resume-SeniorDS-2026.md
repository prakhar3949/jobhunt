# Prakhar Goyal
**Senior Data Scientist — Production ML, Forecasting & Applied AI**
...
## Summary
Senior data scientist with **9+ years** delivering high-impact ML across retention, pricing, lifetime value, and risk — including **$150M+ in incremental revenue** at FedEx. Owns the full lifecycle: problem framing, modeling, and production MLOps (Databricks, MLflow, Azure Data Factory, Terraform). Strong applied breadth — forecasting, gradient boosting, optimization, and recommendation systems — now extended into **Generative AI / LLM engineering** through a live agentic LLM project. MS in Business Analytics (GPA 3.96).
...
## Applied AI Project — 2025 to Present
**AI Hedge-Fund Tooling Suite** — agentic, LLM-driven quantitative-research system
- Architected an **agentic LLM system (Claude API)** orchestrating 30+ analysis tools across market, options, macro, and fundamentals data, with **RAG-style pipelines** turning live market/economic feeds into LLM-generated research delivered through automated workflows.

---

## Selected Projects
- **Optical Digit Recognition** — CNN (Keras), **99.42%** accuracy with hyperparameter tuning; Python/tkinter app.
- **Bitcoin Price Forecasting** — seasonal ARIMA with EDA-driven differencing; R/Shiny deployment.
